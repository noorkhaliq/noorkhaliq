...
@section('mainContent')
    <div class="content-wrapper col-md-9 mt-3" style="margin-left: 18rem;margin-bottom: 3rem;">
        <div class="card card-primary" style="background: #858f912e" >
            ...
            <form method="post" action="{{ route('services.save') }}"  enctype="multipart/form-data" class="p-3">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea name="text" id="summernote" class="form-control">{{ old('text') }}</textarea>
                </div>
                <br> <br>
